...
import { addToCart } from '@/application/cart/actions/add-to-cart.action';
import { removeFromCart } from '@/application/cart/actions/remove-from-cart.action';
import { useCartStore } from '@/store/cart.store';
import { useToast } from '@/presentation/hooks/use-sonner-toast.ts';
import { clearCart } from '@/application/cart/actions';
